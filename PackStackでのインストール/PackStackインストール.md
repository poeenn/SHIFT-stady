...
CONFIG_SSL_CERT_SUBJECT_CN=150-95-130-49

CONFIG_SSL_CERT_SUBJECT_MAIL=admin@150-95-130-49
...
CONFIG_KEYSTONE_ADMIN_TOKEN=dde2d19bb87d4f278f45338ce41de155
...
# database.
CONFIG_GLANCE_DB_PW=97c88b78c7fe4b26

# Password to use for the Image service to authenticate with the
# Identity service.
CONFIG_GLANCE_KS_PW=3553529d4ff24dd5
...
# the database.
CONFIG_CINDER_DB_PW=9dde5e8ab17f46c9
...
CONFIG_CINDER_KS_PW=a7cb98e38edd4062
...
# database.
CONFIG_NOVA_DB_PW=3384663ec7934fb8

# Password to use for the Compute service to authenticate with the
# Identity service.
CONFIG_NOVA_KS_PW=dbb6db1a46004125
...
CONFIG_NEUTRON_KS_PW=0e68e52163d24397

# The password to use for OpenStack Networking to access the
# database.
CONFIG_NEUTRON_DB_PW=98e6fe066e484725
...
CONFIG_NEUTRON_METADATA_PW=0e5b95fef27e43d9
...
CONFIG_HORIZON_SECRET_KEY=8da13d7b2ee24fa0947a2054bd3afaa0
...
# the Identity service.
CONFIG_SWIFT_KS_PW=f7d385fbf3b74cd5
...
CONFIG_SWIFT_HASH=2ad6fb44b02b47fe
...
CONFIG_HEAT_AUTH_ENC_KEY=4da09d88d10f4a43
...
CONFIG_CEILOMETER_SECRET=1027da64bd604256
